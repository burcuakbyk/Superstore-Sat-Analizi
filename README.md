...
- East bölgesi güçlü bir performans sergilemektedir.
- Central bölgesi orta seviyede performans göstermektedir.
- South bölgesi satış ve kârlılık açısından en düşük performansa sahiptir ve geliştirilmesi gereken bölge olarak öne çıkmaktadır.
## Bulgular

(Buraya analiz sonuçlarını ekleyeceğiz.)
